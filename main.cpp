/**********************************************PREPROCESSORS**********************************************************/
//Train Reservation System - Created by - Akash Chaudhary..
...
void viewdetails(void)
{
	...
	printf("-----------------------------------------------------------------------------");
	printf("\n1001\tRed Lines Express\tMeerut to Happur\tRs.5000\t\t9am");
	printf("\n1002\tRed Lines Express\tHappur To Meerut\tRs.5000\t\t12pm");
	printf("\n1003\tLA City Express\t\tMeerut To Muzaffarnagar\t\tRs.4500\t\t8am");
	printf("\n1004\tLA City Express\t\tMuzaffarnagar To Meerut\t\tRs.4500\t\t11am");
	printf("\n1005\tIron City Express\tMeerut To Delhi\tRs.4000\t\t7am");
	printf("\n1006\tIron City Express\tDelhi To Meerut\tRs.4000\t\t9.30am");
    printf("\n1007\tKeystone Express\tMeerut To Mumbai\tRs.3500\t\t1pm");
    printf("\n1008\tKeystone Express\tMumbai To Meerut\tRs.3500\t\t4pm");
    printf("\n1009\tMeteor Express\t\tMeerut To Lucknow\t\tRs.6000\t\t3.35pm");
    printf("\n1009\tMeteor Express\t\tLucknow To Meerut\t\tRs.6000\t\t4.15pm");
...
void specifictrain(int train_num)
{
	...
	if (train_num==1001)
	{
		printf("\nTrain:\t\t\tHappur Lines Express");
		printf("\nDestination:\t\tMeerut to Happur");
		printf("\nDeparture:\t\t9am ");
	}
	if (train_num==1002)
	{
		printf("\nTrain:\t\t\tMeerut Lines Express");
		printf("\nDestination:\t\tHappur to Meerut");
		printf("\nDeparture:\t\t12pm");
	}
	if (train_num==1003)
	{
		printf("\nTrain:\t\t\t Muzaffarnagar Express");
		printf("\nDestination:\t\tMeerut To Muzaffarnagar");
		printf("\nDeparture:\t\t8am");
	}
	if (train_num==1004)
	{
		printf("\nTrain:\t\t\tLA City Express");
		printf("\nDestination:\t\tMuzaffarnagar to Meerut");
		printf("\nDeparture:\t\t11am ");
	}
	if (train_num==1005)
	{
		printf("\nTrain:\t\t\tDelhi City Express");
		printf("\nDestination:\t\tMeerut To Delhi");
		printf("\nDeparture:\t\t7am");
	}
	if (train_num==1006)
	{
		printf("\ntrain:\t\t\tMeerut City Express");
		printf("\nDestination:\t\tDelhi to Meerut");
		printf("\nDeparture:\t\t9.30am ");
	}
	if (train_num==1007)
	{
		printf("\ntrain:\t\t\tMumbai Express");
		printf("\nDestination:\t\tMeerut To Mumbai");
		printf("\nDeparture:\t\t1pm ");
	}
	if (train_num==1008)
	{
		printf("\ntrain:\t\t\tMeerut Express");
		printf("\n Destination:\t\tMumbai to Meerut");
		printf("\nDeparture:\t\t4pm ");
	}
	if (train_num==1009)
	{
		printf("\ntrain:\t\t\tLucknow Express");
		printf("\nDestination:\t\tMeerut To Lucknow");
		printf("\nDeparture:\t\t3.35pm ");
	}
	if (train_num==1010)
	{
		printf("\ntrain:\t\t\tMeerut Express");
		printf("\nDestination:\t\tLucknow to Meerut");
		printf("\nDeparture:\t\t1.15 ");
	}
}
